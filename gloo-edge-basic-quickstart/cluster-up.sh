...
k3d_server_count=${3:-1}

k3d cluster create --servers $k3d_server_count --network k3d-$k3d_cluster_name --api-port $k3d_cluster_port -p "80:80@server[0]" -p "443:443@server[0]" --no-lb --k3s-server-arg '--no-deploy=traefik' $k3d_cluster_name
